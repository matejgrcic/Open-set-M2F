...
from mask2former.trainers.joint_trainer import JointTrainer
...
class Trainer(DefaultTrainer):
    ...
    def build_train_loader(cls, cfg):
        ...
        if cfg.INPUT.DATASET_MAPPER_NAME == "mask_former_semantic":
            ...
            return build_detection_train_loader(cfg, mapper=mapper)
        elif cfg.INPUT.DATASET_MAPPER_NAME == "mask_former_semantic_traffic_uno":
            mapper = MaskFormerSemanticDatasetMapperWithUNO(cfg, True)
            return build_detection_train_loader(cfg, mapper=mapper)
    ...
    def build_optimizer(cls, cfg, model):
        ...
        for module_name, module in model.named_modules():
            if "flow" in module_name: continue
