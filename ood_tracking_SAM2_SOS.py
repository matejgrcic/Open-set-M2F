...
sam2_checkpoint = "/home/adelic/segment-anything-2/checkpoints/sam2_hiera_small.pt"
...
if DATASET == 'sos':
    ...
    res_dir = './data/street_obstacle_sequences/ood_prediction_tracked_n/'
    result_video_dir = '/mnt/sdb1/datasets/street_obstacle_sequences/result_videos_n/'
    threshold = 0.52
