...
# from mask2former.modeling.flow.dense_flow import DenseFlow
from denseflow import DenseFlow

@META_ARCH_REGISTRY.register()
class MaskFormerJointFlow(nn.Module):
    """
    ...
    def from_config(cls, cfg):
        ...
        jsd_weight = cfg.MODEL.MASK_FORMER.JSD_WEIGHT
        ...
        weight_dict = {"loss_ce": class_weight, "loss_mask": mask_weight, "loss_dice": dice_weight, "loss_jsd": jsd_weight}
    ...
    def forward(self, batched_inputs, images=None, gt_instances=None, image_sizes=None):
        """
        Args:
